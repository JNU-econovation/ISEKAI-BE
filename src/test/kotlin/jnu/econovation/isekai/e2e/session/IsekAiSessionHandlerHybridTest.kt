...
//            val voiceId = invocation.getArgument<Long>(0)
//            val requestFlow = invocation.getArgument<Flow<String>>(1)
//            val readySignal = invocation.getArgument<CompletableDeferred<Unit>>(2)
//
//            readySignal.complete(Unit)
//
//            requestFlow.map { request ->
//                logger.info { "[Mock TTS] Gemini가 보낸 텍스트 변환 요청 수신: $request" }
//                val dummyAudio = ByteArray(100) { 0xAA.toByte() }
//                TTSResult(payload = dummyAudio, isFinal = true)
//            }.onEach {
//                delay(50)
//            }
//        }
...
//    fun e2eWithTextMessageAndMockTTS() {
//        val connectionLatch = CompletableDeferred<Unit>()
//        readyLatch = CompletableDeferred()
//        subtitleLatch = CompletableDeferred()
//
